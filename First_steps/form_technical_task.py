...
def signatory(ws, factory_id, row_num):
    signatories = {'7Q11': 'Технический директор-главный инженер _________________________ А.В.Пиголицын',
                   '7Q31': 'Технический директор-главный инженер _________________________ Р.Г.Валлиулин',
                   '7Q41': 'Технический директор-главный инженер _________________________ Д.А.Чернядьев',
                   '7Q91': 'Начальник административно-хозяйственного отдела _________________________ С.В.Гузняков',
                   '7Q61': 'Технический директор-главный инженер _________________________ А.Н.Тихонов',
                   '7QB1': 'Технический директор-главный инженер _________________________ А.В.Семянов'}
    format1 = final_wb.add_format({'align': 'left', 'bold': True, 'font': 'Tahoma', 'font_size': 16})
    format1.set_align('bottom')
    ws.set_row(row_num - 1, 48)
...
if __name__ == "__main__":
    ...
    factories = ('7Q11', '7Q31', '7Q41', '7Q91', '7Q61', '7QB1', '7QR1')  # коды грузополучателей
    data = pd.read_excel('load_rele.xlsx', sheet_name='Sheet1')
    ...
    tables_repairs[2].to_excel('temp_rele.xlsx', merge_cells=False)
    temp_wb = load_workbook(filename='temp_rele.xlsx', data_only=True, read_only=True)
